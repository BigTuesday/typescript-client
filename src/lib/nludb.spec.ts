...
test('Test Embeddings', async (t) => {
  ...
  const e1 = await nludb.embed({texts: ["This is a test"], model: EmbeddingModel.QA})
  const e1b =await nludb.embed({texts: ["Banana"], model: EmbeddingModel.QA})
  const e2 = await nludb.embed({texts: ["This is a test"], model: EmbeddingModel.QA})
  const e3 = await nludb.embed({texts: ["This is a test"], model: EmbeddingModel.SIMILARITY})
  const e3b =await nludb.embed({texts: ["Banana"], model: EmbeddingModel.SIMILARITY})
  const e4 = await nludb.embed({texts: ["This is a test"], model: EmbeddingModel.SIMILARITY})
  const e5 = await nludb.embed({texts: ["This is a test"], model: EmbeddingModel.PARAPHRASE})
  const e5b =await nludb.embed({texts: ["Banana"], model: EmbeddingModel.PARAPHRASE})
  const e6 = await nludb.embed({texts: ["This is a test"], model: EmbeddingModel.PARAPHRASE})
